    ...
    <div>
        <div class="border-b border-gray-800">
            <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
                ...
                <div class="md:ml-24">
                    ...
                    <div  v-if="movie.videos.results.length > 0">
                        <div class="mt-12">
                            <button
                                v-for="(trailer, index) in movie.videos.results.slice(0, 3)" :key="trailer.id"
                                @click="openTrailer(movie.videos.results[index].key)"
        ...
        <div class="container mx-auto px-4 py-16">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                <div class="mt-8" v-for="image in movie.images.backdrops" :key="image.id">
                    <a
...
<script>
    export default {
        ...
        methods: {
            fetchMovie(id) {
                axios.get(`https://api.themoviedb.org/3/movie/${id}?api_key=c2e68a00a417e16e82e7a9b1666fca2e&append_to_response=credits,images,videos`).then((res) => {
                    this.movie = res.data;
